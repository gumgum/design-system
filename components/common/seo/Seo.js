...
export const Seo = withRouter(({ title, description, image = ogImage, router, children }) => (
    <Head>
        ...
        {title != undefined && <title key="title">{title} | React Table | TanStack</title>}
        ...
        <meta name="twitter:creator" key="twitter:creator" content="@tannerlinsley" />
